...
This step expects that you have a program installed on your server and it is running on a port. We are running Writefreely installed from the tutorial [[NA-Suggested tools to host.md]] and it runs on port `8080`. 
