...
Once you are logged in to your user on the pi, we will install nginx from the command line. We will use `apt` , which is a command-line tool that uses the Advanced Package Tool to download and install packages onto your device. 
