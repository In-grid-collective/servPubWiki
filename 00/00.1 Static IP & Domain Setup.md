...
We put the section on cerbot in the Reverse Proxy set up section as it was the last step in the setup of the servpub VPN, see [[04.2 SSL certificates for https]] for steps on how to use certbot to self-sign certificates. 